        ...
        for(int vertexI = 0; vertexI < 4; vertexI++) {
            ...
            if(Config.simplifyChunkMeshes) {
                if((quadCountByUVDirection(false) == 1 && quadCountByUVDirection(true) == 1)) {
                    ...
                    out.writeByte(us[vertexI] == us[provokingI] ? 0 : (byte)quadCountByUVDirection(false));
                    out.writeByte(vs[vertexI] == vs[provokingI] ? 0 : (byte)quadCountByUVDirection(true));
                    out.writeByte(us[vertexI] == us[provokingI] ? (byte)0 : 1);
                    out.writeByte(vs[vertexI] == vs[provokingI] ? (byte)0 : 1);
                }
            }
